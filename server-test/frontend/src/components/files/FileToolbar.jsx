...
export default function FileToolbar({ selectedFile, onUpload, onNewFolder, onNewFile, onDelete, onDownload, onRefresh }) {
  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <div className="flex items-center space-x-1 bg-[#141414] rounded-lg border border-[#1f1f1f]">
        <button 
          onClick={onNewFolder} 
          className="p-2 text-gray-500 hover:bg-[#1a1a1a] rounded-l-lg transition-colors" 
          title="New Folder"
        >
        ...
        <button 
          onClick={onNewFile} 
          className="p-2 text-gray-500 hover:bg-[#1a1a1a] transition-colors" 
          title="New File"
        >
        ...
        <div className="w-px h-6 bg-[#1f1f1f] bg-[#1f1f1f]" />
        <button 
          onClick={onDownload} 
          disabled={!selectedFile || selectedFile.type === 'folder'} 
          className="p-2 text-gray-500 hover:bg-[#1a1a1a] disabled:opacity-50 disabled:cursor-not-allowed transition-colors" 
          title="Download"
        >
        ...
        <button 
          ...
          className="p-2 text-red-500 hover:bg-red-900/40 disabled:opacity-50 disabled:cursor-not-allowed rounded-r-lg transition-colors" 
          title="Delete"
        >
