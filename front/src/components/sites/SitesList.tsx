...
export default function SitesList({ sites, selectedSite, onSiteSelect, onSiteUpdate }: SitesListProps) {
  ...
  const handleAction = (site: Site, action: string) => {
    ...
    switch (action) {
      ...
      case 'restart':
        ...
        setTimeout(() => {
          onSiteUpdate({ ...site, status: 'online' });
        }, 2000);
        break;
      case 'ssl':
        onSiteUpdate({ ...site, ssl: !site.ssl });
        return;
    }
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-1">
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    handleAction(site, site.status === 'online' ? 'stop' : 'start');
                  }}
                ...
                <button
                  ...
                  title={site.ssl ? 'Disable SSL' : 'Enable SSL'}
                >
                ...
                <button
                  ...
                  className="p-1.5 rounded-md text-purple-600 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors"
                  title="Preview Site"
                >
